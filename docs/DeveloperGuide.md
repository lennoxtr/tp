...
| `* *`    | user             | export my progress data to an existing file                                        | update my backed up data in case I drop a module or take a new module                                                          |
| `* *`    | user             | import all my progress data from a file                                            | restore my tracker should I change or wipe my device                                                                           |
| `* *`    | user             | import some progress data from a file                                              | revise and relearn specific modules I took in the past, as well as track my productivity level                                 |
